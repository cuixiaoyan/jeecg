...
<body style="background-color: #FFFFFF;">
	<div id="keysignatureList" v-cloak>
		...
		<el-row style="margin-top: 15px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<el-form-item style="margin-bottom: 8px;" prop="byTime_begin">
					<el-date-picker type="date" placeholder="选择截止时间开始" v-model="filters.byTime_begin"></el-date-picker>
				</el-form-item>
				<el-form-item style="margin-bottom: 8px;" prop="byTime_end">
					<el-date-picker type="date" placeholder="选择截止时间结束" v-model="filters.byTime_end"></el-date-picker>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="keysignatures" border stripe size="mini" highlight-current-row v-loading="listLoading" @sort-change="handleSortChange"  @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="userName" label="用户名称" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="byTime" label="截止时间" min-width="120" sortable="custom" show-overflow-tooltip :formatter="formatDate"></el-table-column>
				...
				let para = {
					params: {
						...
						order:this.sort.order,
					 	byTime_begin: !this.filters.byTime_begin ? '' : utilFormatDate(new Date(this.filters.byTime_begin ), 'yyyy-MM-dd'),
						byTime_end: !this.filters.byTime_end ? '' : utilFormatDate(new Date(this.filters.byTime_end ), 'yyyy-MM-dd'),
						field:fields.join(',')
					}
				};
