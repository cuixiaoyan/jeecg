...
<body style="background-color: #FFFFFF;">
	<div id="authorizedmenuList" v-cloak>
		<!--工具条-->
		<el-row style="margin-top: 15px;">
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				<%--<el-form-item>--%>
			    	<%--<el-button type="primary" icon="el-icon-search" v-on:click="getAuthorizedmenus">查询</el-button>--%>
			    <%--</el-form-item>--%>
			    <%--<el-form-item>--%>
		...
		<!--列表-->
		<el-table :data="authorizedmenus" border stripe size="mini" highlight-current-row v-loading="listLoading" @sort-change="handleSortChange"  @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55"></el-table-column>
			<el-table-column type="index" width="60"></el-table-column>
			<el-table-column prop="sortMenu" label="菜单排序" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="nameTheMenu" label="菜单名称" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			<el-table-column prop="menuNumber" label="菜单编号" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
		...
		<!--新增界面-->
		<el-dialog width="50%" :title="formTitle" fullscreen z-index="800" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="form" label-width="80px" :rules="formRules" ref="form" size="mini">
					<el-form-item label="菜单排序" prop="sortMenu">
						<el-input v-model="form.sortMenu" auto-complete="off" placeholder="请输入菜单排序"></el-input>
					</el-form-item>
					<el-form-item label="菜单名称" prop="nameTheMenu">
						<el-input v-model="form.nameTheMenu" auto-complete="off" placeholder="请输入菜单名称"></el-input>
					</el-form-item>
					<el-form-item label="菜单编号" prop="menuNumber">
						<el-input v-model="form.menuNumber" auto-complete="off" placeholder="请输入菜单编号"></el-input>
					</el-form-item>
			</el-form>
...
<script>
	var vue = new Vue({			
		el:"#authorizedmenuList",
		data() {
			return {
				filters: {
				},
				url:{
					list:'${webRoot}/authorizedmenuController.do?datagrid',
					del:'${webRoot}/authorizedmenuController.do?doDel',
					batchDel:'${webRoot}/authorizedmenuController.do?doBatchDel',
					queryDict:'${webRoot}/systemController.do?typeListJson',
					save:'${webRoot}/authorizedmenuController.do?doAdd',
					edit:'${webRoot}/authorizedmenuController.do?doUpdate',
					upload:'${webRoot}/systemController/filedeal.do',
					downFile:'${webRoot}/img/server/',
					exportXls:'${webRoot}/authorizedmenuController.do?exportXls&id=',
					ImportXls:'${webRoot}/authorizedmenuController.do?upload'
				},
				authorizedmenus: [],
				total: 0,
				page: 1,
		...
		methods: {
			...
			//导入
			ImportXls: function(){
				openuploadwin('Excel导入',this.url.ImportXls, "authorizedmenuList");
			},
			//初始化数据字典
