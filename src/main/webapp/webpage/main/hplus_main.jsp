            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header" style="padding:0;">
                    <div class="dropdown profile-element">
                                <span><img alt="image" width="200" height="61" src="plug-in/login/images/jeecg-aceplus.png" /></span>
                    </div>
                    <div class="logo-element">cxy
                    </div>
                </li>
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="ようこそ" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
