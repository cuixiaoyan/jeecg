package com.jeecg.authorizedmenu.service.impl;
...
@Service("authorizedmenuService")
@Transactional
public class AuthorizedmenuServiceImpl extends CommonServiceImpl implements AuthorizedmenuServiceI {
