package com.jeecg.cxy_conventional.service.impl;
...
@Service("cxyConventionalService")
@Transactional
public class CxyConventionalServiceImpl extends CommonServiceImpl implements CxyConventionalServiceI {
